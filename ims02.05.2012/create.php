...
$ulevel = 2;
 ...
 if (!$resp->is_valid) {
  header("Location:signup.php?err=<h3>CAPTCHA was entered incorrectly</h3>");
...
header("Location:index.php?err=<h3>Congratulations! You have successfully Created Your Account.</h3>");
