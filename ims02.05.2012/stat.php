...
<h1><center>
  <p>&nbsp;</p>
  <p><font face="Times New Roman, Times, serif">Stationary</font></p>
</center></h1></td></tr><tr>
  <td><form action="stainsert.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
<table width="881" height="287"border="0"  align="center" >
    <td width="214" height="45"><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Item Name</font></h4></td>
    <td width="213">
      <label for="no"></label><select id="itemssta" name="itemssta" onChange="showState(this.value)">

<?php foreach ($stationary as $key => $value) { ?>
                          <option value="<?php echo $key; ?>" <?php //selected($key,$row_contact['contact_country']); ?>><?php echo $value; ?></option>
<?php } ?>

       
                        </select>    </td>
    <td width="167"><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h4></td>
    <td width="269">
      <label for="articles"></label>
      <input name="datesta" type="text" class="required" id="datesta" value="<?php //echo $row_contact['contact_last']; ?>" size="25" />   </td>
  </tr>
  <tr>
    <td height="46"><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">No of item</font></h4></td>
    <td><input name="noista" type="number"  min="1" max="999" class="required" id="noista" " size="25" /></td>
    <td><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Balance</font></h4></td>
    <td>
      <label for="folio"></label>
      <input name="balsta" type="text" class="required" id="balsta" value="<?php //echo $row_contact['contact_last']; ?>" size="25" />    </td>
  </tr>
  <tr>
    <td height="59">&nbsp;&nbsp;<h4>&nbsp;</h4></td>
    <td>
      Received<input name="actsta" type="radio" class="required" id="act1s" value="received" size="25" />
		 Issued<input name="actsta" type="radio" class="required" id="act2s" value="issued" size="25" />
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
