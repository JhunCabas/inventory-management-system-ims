...
<?php } ?>
  ...
  <tr>
    ...
    <td>
      Add<input name="actmai" type="radio" class="required" id="act1m" value="add" size="25" />
		 Issue<input name="actmai" type="radio" class="required" id="act2m" value="issue" size="25" /> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
