...
<div class="sidebar_box">
       	...
       	<h4>Our pages</h4>
                <ul class="tmo_list">
                  <li><a href="index.php">Our e-mail</a></li>
                    <li><a href="http://www.inventorymanagementsystemims.blogspot.com/" target="_blank">Our Blogs page</a></li>
                    <li><a href="index.php">Our google+</a></li>
        </ul>
          </div>
   	    </div>
