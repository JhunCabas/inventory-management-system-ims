...
<table width="959" height="475"border="0"  align="center" ><font color="#99CCFF">

<tr>
<td width="175"><h6><img src="images/templatemo_list.png"/>&nbsp;&nbsp;<font color="#99CCFF">Articles</font></h6> </td>
<td width="175">
  <label for="no"></label>
...
<td width="184"><h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Identification No</font></h6></td>
<td width="306">
  <label for="articles"></label>
  <input name="id_no" type="text" class="required" id="id_nooe" value="<?php //echo $row_contact['contact_last']; ?>" size="25" /></td>
</tr>
<tr>
  <td><h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h6></td>
<td><input name="date" type="text" class="required" id="dateoe" value="<?php //echo $row_contact['contact_last']; ?>" size="25" /></td>
<td><h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Folio No</font></h6>
</td>
<td>
  <label for="folio"></label>
  <input name="f_no" type="text" class="required" id="f_nooe" value="<?php //echo $row_contact['contact_first']; ?>" size="25" /></td>
</tr>
<tr>
...
<td>
  ...
  <input name="nos" type="text" class="required" id="nos" value="<?php //echo $row_contact['contact_first']; ?>" size="25" /></td>
</tr>
<tr>
  <td><h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Unit Price</font></h6></td>
<td>
  <label for="price"></label>
  <input name="up" type="text" class="required" id="up" value="<?php //echo $row_contact['contact_last']; ?>" size="25" /></td>
<td><h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Officer in Charge</font></h6></td><td>
  <label for="charge"></label>
  <input name="off" type="text" class="required" id="off" value="<?php //echo $row_contact['contact_first']; ?>" size="25" /></td>
</tr>
<tr>
