...
<div id="templatemo_main_wrapper">
	<div id="templatemo_main">
   	  ...
   	  <p><center><h2>&nbsp;</h2>
   	    ...
   	    <h2><font  size="+3" face="Times New Roman, Times, serif">Sign Up</font> </h2>
      </center>
...
<tr>
		...
		<form  method="post" action="create.php">
          <table width="951" height="304">
            ...
            <tr><td width="337"></td><td width="110"><h6><font color="#99CCFF"><img src="images/templatemo_list.png" />&nbsp;&nbsp;&nbsp;First Name</font></h6></td><td width="54"></td><td><input name="firstname" type="text" /></td></tr><tr><td></td><td width="110"><h6><font color="#99CCFF"><img src="images/templatemo_list.png" />&nbsp;&nbsp;&nbsp;Last Name</font></h6></td><td></td><td><input name="lastname" type="text" /></td></tr><tr><td></td><td width="110"><h6><font color="#99CCFF"><img src="images/templatemo_list.png" />&nbsp;&nbsp;&nbsp;e-mail</font></h6></td><td></td><td width="430"><input name="email" type="text" /></td>
              </tr><tr><td></td><td width="110"><h6><font color="#99CCFF"><img src="images/templatemo_list.png" />&nbsp;&nbsp;&nbsp;UserName</font></h6></td><td></td><td><input name="username" type="text" /></td>
                </tr><tr><td></td><td width="110"><h6><font color="#99CCFF"><img src="images/templatemo_list.png" />&nbsp;&nbsp;&nbsp;Password</font></h6></td><td></td><td><input name="password" type="password" /></td>
				
                  </tr><tr><td></td><td></td><td><?php
          require_once('recaptchalib.php');
          $publickey = "6LcC5swSAAAAAH5VgS8BDPOeAiecjPvsRx7z3B37"; // you got this from the signup page
          echo recaptcha_get_html($publickey);
        ?></td><td></td><td></td>
				
                  </tr><tr><td height="73"></td><td></td><td >
