...
<div id="templatemo_main_wrapper">
	<div id="templatemo_main">
   	  ...
   	  <p>&nbsp;</p>
	  <p><center>
   	    <h2><font  size="+3" face="Times New Roman, Times, serif">Loan </font></h2>
   	    <font  size="+2">
	    </font>
	  </center>
	  <font  size="+2">
	  <table width="359" height="91" align="center">
	  <tr><td width="214"> <a href="loanissue.php">Loan Issue</a></td>
	  <td width="133"><a href="loantaken.php"> Loan Taken</a></td></tr></table></font>
