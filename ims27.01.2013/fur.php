...
<table width="927" height="542"border="0"  align="center" ><font color="#99CCFF">
  ...
  <td width="182"><h4><img src="images/templatemo_list.png"/>&nbsp;&nbsp;<font color="#99CCFF">Articles</font></h4> </td>
<td width="182">
  <p>
    <label for="no"></label>
  </p>
...
<td width="240"><h4><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Identification No</font></h4></td>
<td width="305">
  <p>
    <label for="articles"></label>
    </p>
  <p>
    <input name="id_no" type="text" class="required" id="id_nofu" value="<?php //echo $row_contact['contact_last']; ?>" size="34" />
  </p></td>
</tr>
<tr>
  <td><h4><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h4></td>
<td><p>
  <input name="date" type="text" class="required" id="datefu" value="<?php //echo $row_contact['contact_last']; ?>" size="34" />
  </p></td>
...
<td>
  ...
  <p>
    <input name="f_no" type="text" class="required" id="f_nofu" value="<?php //echo $row_contact['contact_first']; ?>" size="34" />
  </p></td>
</tr>
<tr>
...
<tr>
  <td height="27"><h4><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Remarks</font></h4></td><td>
  <p>
