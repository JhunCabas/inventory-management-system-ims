...
<table width="714" height="405"border="0"  align="center" ><font color="#99CCFF">
<tr>
...
<td>
  ...
  <input name="up" type="text" class="required" id="up" value="<?php //echo $row_contact['contact_last']; ?>" size="25" /></td><td>&nbsp;&nbsp;<h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Officer in Charge</font></h6></td><td>
