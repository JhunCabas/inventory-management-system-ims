...
<?php } ?>
  ...
  <tr>
    ...
    <td>
      Add<input name="actsta" type="radio" class="required" id="act1s" value="add" size="25" />
		 Issue<input name="actsta" type="radio" class="required" id="act2s" value="issue" size="25" />
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
