...
<table width="873" height="328"border="0"  align="center" >
    <td width="162" height="45"><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Item Name</font></h4></td>
    <td width="239">
...
<?php } ?>
    ...
    <td width="186"><h4><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h4></td>
    <td width="314">
  ...
  <tr>
    ...
    <td>
      Received<input name="act" type="radio" class="required" id="act1c" value="received" size="25" />
		 Issued<input name="act" type="radio" class="required" id="act2c" value="issued" size="25" />
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<td height="37"> <font color="#000033"><img  align="right" src="images/lft.png" width="76" height="27" /></td><td><strong><a href="inventory.php">Go to Inventory</a></strong></td></tr>
</table>
  </form>
<div id="feedback">
		</div>
