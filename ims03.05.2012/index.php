      ...
      <div id="templatemo_sidebar">
   	    <div class="sidebar_box">
				<a href="http://www.flashmo.com" target="_parent"></a><center><h2>&nbsp;</h2>
				  <h2>Login</h2>
				  <p>&nbsp;</p>
				</center><form action="validatelogin.php" method="post"><table width="250" height="174"><tr><td width="88">&nbsp;&nbsp;&nbsp;Username</td><td width="172"><input type="text" name="username" id="username" /></td></tr>  <tr><td>&nbsp;&nbsp;&nbsp;Password</td><td><input type="password" name="password" id="password" /></td></tr> <tr><td height="70">&nbsp;</td>
				<td>&nbsp;&nbsp;
				  <input type="submit" name="Login" id="Login" value="Login"/></td></tr></table><center>
...
<div class="sidebar_box">
       	...
       	<h4>Our pages</h4>
                <ul class="tmo_list">
                   ...
                   <li><a href="https://code.google.com/p/inventory-management-system-ims/" target="_blank"><img src="images/googlecode.jpg" /></a></li>
                  <li><a href="https://github.com/kesavany/Inventory-Management-System" target="_blank"><img src="images/github.jpg" /></a></li>  
                    
        </ul>
          </div>
   	  
                <ul class="tmo_list">
                    <li><a href="http://www.inventorymanagementsystemims.blogspot.com/" target="_blank"><img src="images/blogimages.jpg" /></a></li>
                    <li><a href="https://plus.google.com/116146369243540557017/posts" target="_blank"><img src="images/gplusimages.png" /></a></li>
...
<div id="templatemo_footer_wrapper">
	<div id="templatemo_footer">
    	...
    	<div class="footer_col_w300">
          <h4> <li><a href="index.php">Our e-mail : inventorymsystem@gmail.com</a></li></h4>

    	</div>
    	<div class="footer_col_w300"></div>
    	<div class="footer_col_w300 "></div>
    	<div class="cleaner">
    	  <p>&nbsp;</p>
