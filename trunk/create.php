...
$ulevel = 2;
 ...
 if (!$resp->is_valid) {
  header("Location:signup.php?err=<h1>CAPTCHA was entered incorrectly</h1>");
...
header("Location:index.php?err=<h1>Congratulations! You have successfully Created Your Account.</h1>");
