...
<div id="templatemo_main_wrapper">
	<div id="templatemo_main">
	  ...
	  <p>&nbsp;</p>
      <center>
        <h2><font  size="+3" face="Times New Roman, Times, serif">Remove Inventory</font></h2></center>
...
<?php if (!$add && !$show) { ?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td scope="row"><strong>Identification Number</strong></td>
...
<center>
      <p>&nbsp;</p>
	  <table width="951" height="47"><tr><td width="231" height="41"></td><td width="148"><img src="images/lft.gif" width="94" height="23" align="right"  /></td>
  <td width="147"> <strong>&nbsp;&nbsp;&nbsp;<a href="main.php">Go Back</a></strong></td><td width="405"></td></tr></table>
</center>
<div class="cleaner">
