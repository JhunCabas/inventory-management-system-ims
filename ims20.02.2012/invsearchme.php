...
<div id="templatemo_main_wrapper">
   ...
   if(isset($_POST['selLoan'])&&$_POST['sel']=='oe')
	...
	<tr><td width="544">
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
	  <p>Identification Number:</p></p></td><td width="252">
        <p>&nbsp;          </p>
        <p>&nbsp;          </p>
        <p>
    ...
    <td width="33">
	</form><td width="544"></td><td width="252" align="right"><a href="view.php?id=<?php echo $_POST['sel']; ?>"> View All</a></td>
	</tr></table></font>
	...
	<td><?php echo $res['articles']; ?></td><td><?php echo $res['idno']; ?></td><td><?php echo $res['fno']; ?></td><td><?php echo $res['date']; ?></td><td><?php echo $res['supna']; ?></td><td><?php echo $res['up']; ?></td><td><?php echo $res['ofinch']; ?></td><td width="116"><?php echo $res['remarks']; ?></td>
