...
<table width="924" height="298"border="0"  align="center" >
   <td width="145" height="45"><h5><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Item Name</font></h5></td>
    <td width="226">
      <label for="no"></label><select id="itemsmai" name="itemsmai" onChange="showState(this.value)">
...
<?php } ?>
    ...
    <td width="195"><h6><img  src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h6></td>
    <td width="340">
  ...
  <tr>
    ...
    <td><input name="noimai" type="number"  min="1" max="999" class="required" id="noimai" " size="25" /></td>
