...
<tr><td width="192">&nbsp;&nbsp;<h6><img src="images/templatemo_list.png"/>&nbsp;&nbsp;<font color="#99CCFF">Articles</font></h6> </td>
<td width="192">
  <label for="no"></label>
...
<td width="238">&nbsp;&nbsp;
  <h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Identification No</font></h6></td>
<td width="314">
  <label for="articles"></label>
  <input name="id_no" type="text" class="required" id="id_nole" value="<?php //echo $row_contact['contact_last']; ?>" size="25" />
</td>
</tr>
<tr>
  <td>&nbsp;&nbsp;<h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Date</font></h6></td>
<td><input name="date" type="text" class="required" id="datele" value="<?php //echo $row_contact['contact_last']; ?>" size="25" /></td>
<td>&nbsp;&nbsp;<h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Folio No</font></h6>
</td>
<td>
  <label for="folio"></label>
  <input name="f_no" type="text" class="required" id="f_nole" value="<?php //echo $row_contact['contact_first']; ?>" size="25" />
</td>
</tr>
...
<tr><td height="60">&nbsp;&nbsp;<h6><img src="images/templatemo_list.png" />&nbsp;&nbsp;<font color="#99CCFF">Remarks</font></h6></td><td>
